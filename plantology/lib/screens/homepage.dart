          ...
          children: <Widget>[
            ...
            _selectedImage == null
                ? Container(
                    ...
                    child: Column(
                        children: [
                          Padding(padding:EdgeInsets.all(20),child: Text('Display Box', style: TextStyle(color: Colors.white,fontSize: 30),)),
                          Text('Your information will be displayed here', style: TextStyle(color: Colors.grey,fontSize: 15),)
                        ],
                      ),
                    )
                : Expanded(
